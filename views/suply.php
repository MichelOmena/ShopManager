...
//Include openai safe credentials though function
require_once '../includes/credentials_api.php';
//Config cURL
require_once '../includes/config_cURL.php';
...
<body class="dashboard">
    ...
    <section class="main">
        <div class="sidebar">
            ...
            <a class="sidebar-active" href="./suply.php"><i class="fa-solid fa-network-wired"></i> Fornecedores</a>
           ...
           <!--feed section-->
            <div class="feed p-3">
                <div class="feed-single">
                    ...
                    <div class="feed-time">
                        <button id="generate-report" class="btn btn-secondary"><i class="fa-solid fa-plus"></i> Adicionar Fornecedor</button>
                    </div>
                </div>
            </div>
